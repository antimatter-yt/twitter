  ...
  return (
    <>
      ...
      overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none
       bg-neutral-800 bg-opacity-80 text-white"
      >
        <div
          className="relative w-full lg:w-3/6 my-6 mx-auto lg:max-w-3xl h-full
         lg:h-auto"
        >
          {/* content */}
          <div
          ...
          >
            ...
            <div className="flex items-center justify-center p-10 rounded-t">
              ...
              <button className="p-1 ml-auto border-o text-white
               hover:opacity-70 transition">
                <AiOutlineClose size={28} onClick={handleClose} />
              </button>
            </div>
            {/* body */}
            ...
            <div className="flex flex-col gap-2 p-10">
                ...
                secondary fullwidth onClick={handleSubmit}/>
                {footer}
            </div>
          </div>
        </div>
